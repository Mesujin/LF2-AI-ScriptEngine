...
#pragma once
 ...
 // Commands
  ...
  // Version Control
   ...
   #define _AISCRIPT_FORDARKFIRENEXE true
   ...
   #define _AISCRIPT_DDRAWDLLVERSION string("v2.4") + string(_AISCRIPT_OLDVANGELSCRIPT ? "A" : "") + string(_AISCRIPT_NEORACOMPATIBLE ? "N" : "") + string(_AISCRIPT_FORDARKFIRENEXE ? "N" : "")
