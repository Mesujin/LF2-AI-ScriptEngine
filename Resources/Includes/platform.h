...
#pragma once
 ...
 // Commands
  ...
  // Version Control
   ...
   #define _AISCRIPT_SLOWINPUTUPDATE true
   ...
   #define _AISCRIPT_PDKNEOMAXOBJNUM 1000i32
   #define _AISCRIPT_PDKNEOMAXOBJFRM 800i32
   #define _AISCRIPT_MAXSTAGESIDSLOT 60i32
   #define _AISCRIPT_AISCRIPTADDRESS "ai"
   #define _AISCRIPT_DDRAWDLLVERSION string("v2.5") + string(_AISCRIPT_FORPDKNNEORAEXE ? "N" : "") + string(_AISCRIPT_FORDARKFIRENEXE ? "DF" : "") + string(_AISCRIPT_SLOWINPUTUPDATE ? "" : "TU")
